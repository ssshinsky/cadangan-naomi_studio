...
<main class="bg-naomi-bg min-h-screen">
    ...
    {{-- HERO SECTION --}}
    <section class="relative min-h-[55vh] flex items-center pt-14 pb-20 px-8 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-7">
                <span class="inline-block px-4 py-1.5 bg-primary/10 text-primary text-[10px] font-black tracking-[0.4em] uppercase mb-5 rounded-full">
                    The Editorial Stage
                </span>
                <h1 class="serif-title text-6xl md:text-[80px] font-bold leading-[0.9] tracking-tighter mb-6 text-charcoal">
    ...
    {{-- OUR STORY --}}
    <section class="py-16 bg-naomi-white relative overflow-hidden">
    ...
    {{-- THE SPACES --}}
    <section class="py-16 bg-naomi-bg">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
            <div class="text-center mb-12">
                <span class="text-primary text-[10px] uppercase tracking-[0.5em] font-black mb-3 block">Fasilitas Eksklusif</span>
                <h2 class="serif-title text-5xl md:text-6xl font-bold text-charcoal mb-4 tracking-tighter">The Spaces</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="group">
                    ...
                    <h3 class="serif-title text-3xl font-bold text-charcoal mb-3 group-hover:text-primary transition-colors">Studio Besar</h3>
                    <p class="text-charcoal/120 leading-relaxed mb-5 font-light">
                ...
                <div class="group md:mt-14">
                    ...
                    <h3 class="serif-title text-3xl font-bold text-charcoal mb-3 group-hover:text-primary transition-colors">Studio Kecil</h3>
                    <p class="text-charcoal/120 leading-relaxed mb-5 font-light">
...
{{-- VISION MISSION --}}
    <section class="py-16 bg-white rounded-t-[4rem]">
        <div class="max-w-7xl mx-auto px-6 lg:px-10">
